...
public abstract class Command {
    ...
    */
    public boolean execute(Stack<Command> undoStack) {
        ...
        Command undoCommand = this.getUndoCommand();
     ...
     * AddBoxCommand might use arguments encoding a page number,
     * lower left corner X coordinate in Postscript Points (1/72 in) lower left
     * corner Y coordinate in Postscript Points (1/72 in) width in Postscript
     * Points (1/72 in) height in Postscript Points (1/72 in) i.e. ["3",
     * "72.0", "144.0", "36.5", "80.0"] is interpreted to mean Add Box to Page
     * 3. The box has lower left corner 1 inch (72 points) to the left of the
     * page edge and two 2 inches (144.0 points) down from the top of the page. 
     * The box has a width of 36.5 points and a height of 80.0 points.
     */
