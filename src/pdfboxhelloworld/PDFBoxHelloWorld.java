 ...
 */
 ...
 /* This code is inspired by code at 
...
class PDFBoxHelloWorld_old {
    ...
    public static void main2(String[] args) throws IOException {
        try (// Create a document and add a page to it
            ...
            document.save("/Users/erik/Desktop/Summer2016/CS-7140-Advanced-Software-Engineering/PDFBoxHelloWorld/Hello World.pdf");
        }
    }
 ...
 */
public final class PDFBoxHelloWorld {

    static final float INCH = 72;

    private PDFBoxHelloWorld() {
    }

    public static void main(String[] args) throws IOException {
        if (args.length != 1) {
            System.err.println("Usage: " + PDFBoxHelloWorld.class.getName() + " <output-pdf>");
            System.exit(1);
        }
